...
var test = Person(name: "test")
var testDad = Person(name: "testDad")
var testMum = Person(name: "testMum")
...
class FamilyViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if personArray.count == 0 {
            personArray = [test, testDad, testMum]
...
//            francis.setDad(louis)
                test.setParents(testDad, mum: testMum)
